(0, require("../common/component").VantComponent)({
    ...
    methods: {
        updateExpanded: function() {
            ...
            var t = this.parent.data, n = t.value, e = t.accordion, a = t.items, i = this.data.name, o = a.indexOf(this), s = null == i ? o : i, l = e ? n === s : n.some(function(t) {
                return t === s;
            });
            l !== this.data.expanded && this.updateStyle(l), this.set({
                expanded: l
            });
        },
